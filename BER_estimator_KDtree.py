...
if __name__ == "__main__":
	...
	#print(Y.shape)
	#print(Y)
	e = ensemble_bg_estimator(X,Y, L=5, h_range = [1.0,1.2], ensemble_weights='Chebyshev', N_est_all = 5000, U = 1)
	print(e)

	e = ensemble_bg_estimator(X,Y, L=5, h_range = [1.0,1.2], ensemble_weights='arithmetic', N_est_all = 5000, U = 1)
	print(e)

	e = ensemble_bg_estimator(X,Y, L=5, h_range = [1.0,1.2], ensemble_weights='uniform', N_est_all = 5000, U = 1)
	print(e)
